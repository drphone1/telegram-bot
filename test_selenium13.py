...
# اسکرول به بالا با ActionChains
print("در حال اسکرول به بالای کانال با شبیه‌سازی موس...")
actions = ActionChains(driver)
for _ in range(20):  # 20 بار اسکرول به بالا
    actions.move_to_element(scrollable).scroll_by_amount(0, -500).perform()  # 500 پیکسل به بالا
    ...
    time.sleep(1)  # صبر برای لود پست‌ها
    if current_scroll == 0:
